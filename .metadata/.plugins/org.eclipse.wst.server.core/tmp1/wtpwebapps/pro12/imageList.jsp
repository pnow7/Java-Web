...
.lst_type li{
	overflow:hidden; clear:both; margin:10px 0 0; color:#2d2c2d; 
	font-family:'돋움', Dotum; front=size:12px; line-height:100px;
	list-style:none; border-bottom: 2px solid ligthgray; position:relative; 
}
...
.lst_type li a:hover{text-decoration:uderline}
...
%>
		...
		<li>
			<a href='#' style='margin-left:50px'>
				<img src='image/마리오2.jfif' width='90' height='90' alt='' /></a>
			<a href='#'><strong>이미지 이름: 마리오 <%= i %></strong></a>
